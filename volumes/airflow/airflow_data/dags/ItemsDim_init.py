...
@dag(
    dag_id = "ItemsDim_init",
    start_date=datetime(2025, 1, 1),
    schedule_interval=None,
    catchup=False,
    tags=["init", "ItemsDim", "final project"]
)
...
def ItemsDim_init():
    ...
    def run_command(file, container):
        ...
        if container == "python_scripts":
            ...
            path = "/home/developer/projects/final_project/python_scripts/Parquet/ItemsDim_init/"
        else:
    ...
    @task
    def load_ItemsDim_init():
        run_command("ItemsDim_init.py", "dev_env")
